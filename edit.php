...
if(isset($_GET['editid'])){
    ...
    // Session editing mode
    if (isset($_POST['submit'])) {
        // Getting Post Values for session-based editing
        $fname = $_POST['fname'];
        $lname = $_POST['lname'];
        $contno = $_POST['contactno'];
        $email = $_POST['email'];
        $password = $_POST['password']; // Note the variable name correction here
        $add = $_POST['address'];

        // Query for data updation
        $sql = "update  tblusers set FirstName='$fname', LastName='$lname', MobileNumber='$contno', 
        Email='$email', Password='$password', Address='$add' where ID='$eid'";
...
<img src="propics/<?php  echo $row['ProfilePic'];?>" width="120" height="120">
