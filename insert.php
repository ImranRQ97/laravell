...
if (isset($_POST['submit'])) {
	...
	if (!in_array($extension, $allowed_extensions)) {
		...
		move_uploaded_file($_FILES["profilepic"]["tmp_name"], "propics/" . $imgnewfile);
		// Query for data insertion
		$query = mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email, Password, Address,ProfilePic) 
value('$fname','$lname', '$contno', '$email', '$password', '$add','$imgnewfile' )");
		if ($query) {
...
<body>
	...
	<div class="container">
		...
		$totalRecordsSql = "SELECT COUNT(UserID) AS total FROM tblusers";
		...
		for ($i = 1; $i <= $totalPages; $i++) {
			echo "<a href='insert.php?page=$i'>$i</a> ";
		}
		if ($page < $totalPages) {
